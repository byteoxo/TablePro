...
<Frame caption="EXPLAIN output rendered as a plan tree">
  <img className="block dark:hidden" src="/images/explain-tree.png" alt="Visual query plan tree" />
  <img className="hidden dark:block" src="/images/explain-tree-dark.png" alt="Visual query plan tree" />
</Frame>
