...
Open with `Cmd+,`. Settings are grouped into eight tabs.

<CardGroup cols={2}>
  <Card title="General" icon="gear" href="/customization/settings#general">Language, startup, tabs, sidebar, query timeout, history, updates, reset.</Card>
  <Card title="Appearance" icon="palette" href="/customization/appearance">Appearance mode, themes, per-theme fonts and colors.</Card>
  <Card title="Editor" icon="code" href="/customization/editor-settings">SQL editor, Vim mode, JSON viewer, data grid, pagination.</Card>
