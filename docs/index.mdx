---
title: Introduction
description: Native macOS database client for MySQL, PostgreSQL, SQLite, MongoDB, Redis, and 17 more.
---

# TablePro

Native macOS client for 22 databases. Built with SwiftUI and AppKit, no Electron. The download is about 20 MB.
...
**[Plugin System](/features/plugins)**: 5 bundled drivers covering 8 databases, plus 14 more drivers installable from the plugin registry.
