...
<Frame caption="MCP server settings">
  <img className="block dark:hidden" src="/images/mcp-settings.png" alt="TablePro MCP settings with server status, port configuration, and client setup instructions" />
  <img className="hidden dark:block" src="/images/mcp-settings-dark.png" alt="TablePro MCP settings with server status, port configuration, and client setup instructions" />
</Frame>
